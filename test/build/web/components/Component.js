...
var baseOptions = {
    ...
    beforeCreate(){
        ...
        this[key].event.dispatchEvent( new ComponentEvent( ComponentEvent.COMPONENT_BEFORE_CREATE ) );
    },
    beforeMount(){
        this[key].event.dispatchEvent( new ComponentEvent( ComponentEvent.COMPONENT_BEFORE_MOUNT ) );
    },
    beforeUpdate(){
        this[key].event.dispatchEvent( new ComponentEvent( ComponentEvent.COMPONENT_BEFORE_UPDATE ) );
    },
    beforeDestroy(){
        this[key].event.dispatchEvent( new ComponentEvent( ComponentEvent.COMPONENT_BEFORE_DESTROY ) );
    },
    errorCaptured(){
        this[key].event.dispatchEvent( new ComponentEvent( ComponentEvent.COMPONENT_ERROR_CAPTURED ) );
    },
    created(){
        this.created();
    },
