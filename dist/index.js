...
var require_Token = __commonJS({
  "node_modules/@easescript/transform/lib/core/Token.js"(exports2, module2) {
    init_Node();
    var Token2 = class {
...
function getComponentDirectiveAnnotation(module2) {
  if (!(0, import_Utils7.isModule)(module2))
    return null;
...
var Context = class _Context extends import_Token.default {
  ...
  isDeclaratorModuleDependency(module2) {
    if (!import_Utils16.default.isClassType(module2))
      return false;
...
var Asset = class {
  ...
  async build(ctx2) {
    ...
    if (ctx2.options.emitFile) {
      ...
      import_fs4.default.mkdirSync(import_path3.default.dirname(outfile), { recursive: true });
      import_fs4.default.writeFileSync(outfile, code);
    }
  }
};
...
var package_default = {
  ...
  version: "0.0.1",
  description: "Code Transform To JavasSript For EaseScript Plugin",
  main: "dist/index.js",
...
function plugin(options = {}) {
  if (!initialized) {
    initialized = true;
    createPolyfillModule(import_path5.default.resolve(__dirname, "./polyfills"));
    createPolyfillModule(import_path5.default.resolve("node_modules/@easescript/transform/lib/polyfills"));
  }
